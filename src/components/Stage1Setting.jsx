...
function Stage1Setting() {
    ...
    const handleUpdateClick = () => {
        if (password === '123456') {
            const postData = {
                TotalDay_1: parseInt(totalDay, 10),
                TimeBegin_1: parseInt(timeBegin, 10),
                TimeStop_1: parseInt(timeStop, 10),
                Times_Watering_1: parseInt(timesWatering, 10),
                TotalML_1: parseFloat(totalML)
            };

            fetch('https://ap-southeast-1.aws.data.mongodb-api.com/app/application-0-cavmt/endpoint/VinhPostReactFlow_1', {
                method: 'POST',
                headers: {
    ...
    return (
        <div style={{ border: '1px solid black', padding: '10px', width: '30%' }}>
            <h3>Cài đặt lưu lượng nước giai đoạn 1</h3>
